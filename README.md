# Desafio Back-end PHPay

RIP descrição.

## Avisos antes de começar

- Crie um repositório no seu GitHub **sem citar nada relacionado aos individuos**. :heavy_check_mark:
...
## Objetivo: Você Sabe Quem Simplificado
